...
function addon:InitSettingsPages()
  ...
  local l7apps = AddCheck(lfgChild, l7same, "Show compact role/ilvl/score chips on applicant rows", "applicant_summary_chips", function() SyncAll("applicant_summary_chips") end)
