...
addon.L10N = {
  enUS = {
    ...
    LFG_PRIORITY_TITLE = "Priority Results",
    LFG_PRIORITY_MATCH = "Matches",
    LFG_PRIORITY_OTHER = "Other",
    LFG_PRIORITY_EMPTY = "No LFG results yet.",
    LFG_PRIORITY_HELP = "GroupGuard-owned read-only ranking: matching results first, other results below. Blizzard search data is not modified.",
    ...
    REMOVE_QUEUE_NEEDS_CLICK = "Remove queue is ready. Use /ggremove or /gg queue after combat to run it from your action.",
    ...
    PUG_PRINT_ROW = "%d. %s • %s • %s • iLvl %s • %s",
  ...
  ukUA = {
    ...
    LFG_PRIORITY_TITLE = "Пріоритетні результати",
    LFG_PRIORITY_MATCH = "Підходять",
    LFG_PRIORITY_OTHER = "Інші",
    LFG_PRIORITY_EMPTY = "Результатів LFG ще немає.",
    LFG_PRIORITY_HELP = "Власне read-only сортування GroupGuard: відповідні результати зверху, інші нижче. Дані пошуку Blizzard не змінюються.",
    ...
    REMOVE_QUEUE_NEEDS_CLICK = "Черга видалення готова. Використай /ggremove або /gg queue після бою, щоб виконати її своєю дією.",
