...
addon.L10N = {
  enUS = {
    ...
    PUG_WINDOW_NOTE = "PUGs are raid members who are not in your guild and not direct character/Battle.net friends.",
  ...
  ukUA = {
    ...
    PUG_WINDOW_NOTE = "Пуги — це учасники рейду, які не є членами твоєї гільдії та не є прямими друзями персонажа або Battle.net.",
